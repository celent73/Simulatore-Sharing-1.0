...
export const FEATURES: Feature[] = [
    // SIMULATORS
    {
        ...
        titleDE: 'Sharing Simulator',
        titleEN: 'Sharing Simulator',
        ...
        overviewDE: 'Der Sharing Simulator ist das Herzstück der App. Er ermöglicht es dir, deine potenziellen Einnahmen basierend auf dem Union-Vergütungsplan mathematisch zu simulieren.',
        overviewEN: 'The Sharing Simulator is the heart of the app. It allows you to mathematically simulate your potential earnings based on the Union compensation plan.',
        howToIT: [
    ...
    },
    {
        ...
        category: 'simulators',
        title: 'Sharing Park',
        titleIT: 'Sharing Park',
        titleDE: 'Sharing Park',
        titleEN: 'Sharing Park',
        ...
        isNew: true,
        priority: 1,
        overviewIT: 'Sharing Park ti permette di simulare investimenti in pannelli solari condivisi. Calcola il ROI, i guadagni passivi mensili, e il break-even point del tuo investimento.',
        overviewDE: 'Sharing Park ermöglicht es dir, Investitionen in gemeinsame Solarpanels zu simulieren. Berechne den ROI, monatliche passive Einnahmen und den Break-even-Punkt deiner Investition.',
        overviewEN: 'Sharing Park allows you to simulate investments in shared solar panels. Calculate ROI, monthly passive income, and break-even point of your investment.',
        howToIT: [
    ...
    },
    {
        ...
        titleIT: 'Funzionalità Premium',
        titleDE: 'Premium-Funktionen',
        titleEN: 'Premium Features',
        description: 'Sblocca funzionalità avanzate con la licenza Premium',
        descriptionIT: 'Sblocca funzionalità avanzate come reclute illimitate, export PDF, e analisi dettagliate',
        descriptionDE: 'Schalte erweiterte Funktionen wie unbegrenzte Rekruten, PDF-Export und detaillierte Analysen frei',
        descriptionEN: 'Unlock advanced features like unlimited recruits, PDF export, and detailed analytics',
        icon: '👑',
        color: 'yellow',
        isNew: false,
        priority: 1,
        overviewIT: 'La licenza Premium sblocca il pieno potenziale dell\'app: reclute dirette illimitate (oltre 2), export PDF, statistiche avanzate, e accesso prioritario a nuove features.',
        overviewDE: 'Die Premium-Lizenz schaltet das volle Potenzial der App frei: unbegrenzte direkte Rekruten (über 2), PDF-Export, erweiterte Statistiken und vorrangiger Zugang zu neuen Funktionen.',
        overviewEN: 'The Premium license unlocks the full potential of the app: unlimited direct recruits (over 2), PDF export, advanced statistics, and priority access to new features.',
        howToIT: [
            'Clicca sull\'icona corona 👑 in alto',
            'Inserisci il codice licenza ricevuto',
            'Attiva Premium istantaneamente',
            'Goditi tutte le funzionalità'
        ],
        howToDE: [
            'Klicke auf das Kronensymbol 👑 oben',
            'Gib den erhaltenen Lizenzcode ein',
            'Aktiviere Premium sofort',
            'Genieße alle Funktionen'
        ],
        howToEN: [
            'Click crown icon 👑 at top',
            'Enter received license code',
            'Activate Premium instantly',
            'Enjoy all features'
        ],
        tipsIT: [
            '💡 Licenza valida a vita',
