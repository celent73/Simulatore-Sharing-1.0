...
const IncomePieChart: React.FC<IncomePieChartProps> = ({ levelData, totalOneTimeBonus, totalRecurringYear1 }) => {
  ...
  const data = [
    { name: 'Bonus Una Tantum', value: bonusTotal, color: '#f59e0b' }, // Amber/Yellow
    { name: 'Rendita Diretta (12 mesi)', value: directAnnual, color: '#3b9eff' }, // Union Blue
    { name: 'Rendita da Rete (12 mesi)', value: networkAnnual, color: '#f97316' }, // Union Orange
  ...
  return (
    <div className="bg-white/70 dark:bg-gray-800/60 backdrop-blur-xl rounded-3xl shadow-lg border border-white/40 dark:border-gray-700/50 p-6 h-full flex flex-col">
      <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2 flex items-center gap-2">
        <span className="text-xl">🍰</span> Composizione Guadagni
      </h3>
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">Stima entrate totali 1° Anno</p>
      ...
      <div className="flex-grow min-h-[250px] relative">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[60%] text-center pointer-events-none">
             <p className="text-xs text-gray-400 uppercase font-bold tracking-wider">Totale 1° Anno</p>
