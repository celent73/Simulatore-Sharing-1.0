                    ...
                    subValue={
                        <div className="flex flex-col gap-1 mt-1 pt-1 border-t border-slate-400/30 dark:border-gray-500/30">
                            ...
                            {results.networkStats && results.networkStats.usersCount > 0 && (
                                <div className="flex justify-between items-center text-[10px] mt-1 pt-1 border-t border-dashed border-purple-300 text-purple-600 dark:text-purple-400">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="text-sm font-medium text-gray-700 dark:text-gray-200 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            {results.networkStats && results.networkStats.usersCount > 0 && (
                                <tr className="bg-purple-50/50 dark:bg-purple-900/10 border-t-2 border-purple-100 dark:border-purple-800">
                                    <td className="p-4 font-bold text-purple-700 dark:text-purple-300 flex items-center gap-2">
                                        <span>🟣</span> Network (Livello 0)
                                    </td>
                                    ...
                                    <td className="p-4 text-right font-bold text-purple-900 dark:text-purple-100 bg-purple-100/50 dark:bg-purple-900/30">
                                        +{formatCurrency(results.networkStats.totalAnnualYear1 + results.networkStats.totalAnnualYear2 + results.networkStats.totalAnnualYear3)} <span className="text-[10px] fw-normal opacity-70">(3 Anni)</span>
                                    </td>
                                </tr>
                            )}
                        </tbody>
